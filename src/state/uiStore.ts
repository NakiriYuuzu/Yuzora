...
interface UiState {
    ...
    // Open Settings, optionally selecting a section and Logs source.
    // 無參數＝一般開啟（rail avatar／CommandPalette），不指定 section。
    openSettings: (section?: string, target?: SettingsTargetOptions) => void
